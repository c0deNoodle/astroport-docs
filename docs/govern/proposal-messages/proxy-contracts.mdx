...
<CH.Section>
    <CH.Scrollycoding>
        ...
        [`move_to_proxy`](../../develop/smart-contracts/tokenomics/generator#move_to_proxy) takes in our second proposal message. It contains an `order` of `"2"` and points to the `move_to_proxy` endpoint in the [`Generator`](../../develop/smart-contracts/tokenomics/generator) contract stored in a binary encoded `msg`.  
