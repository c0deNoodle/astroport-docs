...
The simplest way to submit an on-chain proposal is by using the [Astroport Web App](../../learn/workstation/astral-assembly/submitting-a-proposal). Once you have connected a wallet, head over to the Governance tab and select `Submit Proposal`. 
...
Further tutorials on this topic can be found [here](../../develop/tutorials/governance/submitting-a-proposal). 
...
- [**Deregistering a Pool**](./deregistering-a-pool): Deregisters an existing pool. 
