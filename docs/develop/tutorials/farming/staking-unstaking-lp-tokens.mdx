...
<CH.Section>
    <CH.Scrollycoding>
        ...
        The code in this section is an example of a `deposit` message using [feather.js](../tutorials-intro#featherjs) to define our custom function and encode our message.
