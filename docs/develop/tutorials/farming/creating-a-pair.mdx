...
<CH.Section>
    <CH.Scrollycoding>
        ...
        For example, if you want to create a pair on Terra, you can implement this operation using [feather.js](../tutorials-intro#featherjs). 
...
<CH.Section>
    <CH.Scrollycoding>
        ...
        The code in this section is an example of using [feather.js](../tutorials-intro#featherjs) to define a custom function to encode our `init_params` message.
