...
<CH.Section>
    <CH.Scrollycoding>
        ...
        The code in this section is an example of what a `send` message may look like [feather.js](../tutorials-intro#featherjs) to define our custom function and encode our message. 
