...
<CH.Section>
    <CH.Scrollycoding>
        ...
        The code in this section is an example of an [`enter`](../../smart-contracts/tokenomics/staking#enter) message using [feather.js](../tutorials-intro#featherjs) to define our custom function and encode our message.
