...
In cases like these, stableswap AMMs are much more capital-efficient than their constant product counterparts, since most of this amplified liquidity is used to facilitate trades around the 1:1 target exchange rate.
