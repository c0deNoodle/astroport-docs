...
import XYKChartUrl from '@site/static/img/learn/astro-pools/xyk-chart.png';

# Constant Product Pools

Constant product pools are a good choice for token pairs with high volatility (e.g. ASTRO-USDC), as they facilitate trading at all possible prices, even during large, sudden market moves. They are also well suited for primary markets, where traders are more likely to speculate and act on external information despite high slippage.
...
<img src={XYKChartUrl} style={{ paddingBottom: 15 }} />
