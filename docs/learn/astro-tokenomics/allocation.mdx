...
The token distribution was designed in a way that ensures the wider Terra Classic community will have a majority say in everything that happens with Astroport Classic. After the lockdrop, there will be 110M ASTRO in the hands of the community (11% of the total supply) and there is an additional 49% of the supply meant to be distributed to Astroport LPs over 69 years.
