...
<Admonition type="info" title="NOTE">
    ...
    There is no bridge between ASTROC and ASTRO, and each set of tokens governs the deployment on its respective chain. In other words, ASTROC tokens have no governance power over Astroport on Neutron, Terra, Injective, Sei or Osmosis, and ASTRO tokens have no governance power on Astroport on Terra Classic.
</Admonition>
...
<Admonition type="info" title="NOTE">
    Anyone can take out a flashloan from another protocol and then use the borrowed funds to trade on Astroport. Nothing in the Astroport contracts prevents this type of behavior as it is considered valid.
</Admonition>
